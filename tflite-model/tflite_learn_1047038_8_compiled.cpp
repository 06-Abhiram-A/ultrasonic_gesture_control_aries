 ...
 */
// Generated on: 15.07.2026 08:48:06
...
const TfArray<1, float> quant0_scale = { 1, { 0.026124384254217148, } };
const TfArray<1, int> quant0_zero = { 1, { 99 } };
const TfLiteAffineQuantization quant0 = { (TfLiteFloatArray*)&quant0_scale, (TfLiteIntArray*)&quant0_zero, 0 };
const MODEL_SECTION(EI_MODEL_SECTION) ALIGN(16) int32_t tensor_data1[4] = { 54, 29, -562, 339, };
const TfArray<1, int> tensor_dimension1 = { 1, { 4 } };
const TfArray<1, float> quant1_scale = { 1, { 0.00083294435171410441, } };
const TfArray<1, int> quant1_zero = { 1, { 0 } };
const TfLiteAffineQuantization quant1 = { (TfLiteFloatArray*)&quant1_scale, (TfLiteIntArray*)&quant1_zero, 0 };
const MODEL_SECTION(EI_MODEL_SECTION) ALIGN(16) int8_t tensor_data2[4*10] = { 
  -22, 79, 73, 5, -42, -109, -127, -68, 102, 3, 
  68, -21, -93, -104, -82, -71, -21, 32, -43, 43, 
  -126, 8, -71, -62, 61, -75, 77, 43, 3, -90, 
  43, -33, 20, 29, 28, 22, 50, -20, -44, -61, 
};
const TfArray<2, int> tensor_dimension2 = { 2, { 4,10 } };
const TfArray<1, float> quant2_scale = { 1, { 0.0099431956186890602, } };
const TfLiteAffineQuantization quant2 = { (TfLiteFloatArray*)&quant2_scale, (TfLiteIntArray*)&g0::quant1_zero, 0 };
const MODEL_SECTION(EI_MODEL_SECTION) ALIGN(16) int32_t tensor_data3[10] = { 744, 430, 1685, 1285, 627, 1183, 527, -858, 94, -120, };
const TfArray<1, int> tensor_dimension3 = { 1, { 10 } };
const TfArray<1, float> quant3_scale = { 1, { 0.00027886391035281122, } };
...
const MODEL_SECTION(EI_MODEL_SECTION) ALIGN(16) int8_t tensor_data4[10*20] = { 
  45, -10, -6, -10, 114, 63, 120, 5, -15, 36, 38, -16, 38, 127, 102, -22, -8, -3, -11, -4, 
  -1, -76, 39, 35, -22, -47, -80, -61, -53, -19, -44, 31, 1, -55, -26, 45, -58, 35, -43, -68, 
  40, -46, 31, 48, -39, -68, -52, 30, -61, 9, 30, 23, -28, -56, -44, 12, 10, -2, -63, -76, 
  83, 10, 69, 27, -34, -10, -20, 8, -45, 59, 57, -19, -52, -20, -24, -8, -32, -26, 4, -5, 
  -27, 68, -58, -7, -57, 11, -25, 10, 24, 35, 69, 61, -16, 5, -12, -67, 27, 10, 74, 82, 
  18, 41, -21, 10, -50, -65, 5, 66, -67, 70, 80, -42, -61, 55, -37, -62, -22, -24, -58, -12, 
  36, 79, -25, -11, 2, -6, -12, -1, 61, 29, 66, 15, -35, -9, -5, -46, 92, -35, 59, 77, 
  -40, 33, -25, -10, 28, 68, 35, -49, 94, -25, -15, 56, 45, -3, -2, -6, 75, -4, 40, 58, 
  8, -6, 22, 20, 1, -17, -98, -26, -32, -26, -10, 35, -26, -88, -56, 38, -61, 37, -43, -55, 
  14, -66, 20, 5, 79, 83, 12, 1, -4, -16, -45, 18, 38, -2, 48, 24, -37, 62, -48, -36, 
};
const TfArray<2, int> tensor_dimension4 = { 2, { 10,20 } };
const TfArray<1, float> quant4_scale = { 1, { 0.0079827969893813133, } };
const TfLiteAffineQuantization quant4 = { (TfLiteFloatArray*)&quant4_scale, (TfLiteIntArray*)&g0::quant1_zero, 0 };
const MODEL_SECTION(EI_MODEL_SECTION) ALIGN(16) int32_t tensor_data5[20] = { 1360, 365, -650, -492, 320, 148, 2167, -413, -1371, 350, 868, -766, 453, 1715, 1368, -1590, 1575, -873, 217, 629, };
const TfArray<1, int> tensor_dimension5 = { 1, { 20 } };
const TfArray<1, float> quant5_scale = { 1, { 0.00016593505279161036, } };
...
const MODEL_SECTION(EI_MODEL_SECTION) ALIGN(16) int8_t tensor_data6[20*18] = { 
  8, 27, -35, 87, -20, 65, -48, -23, -10, -40, 19, -8, -59, -75, 15, 65, 74, 67, 
  -38, -27, 69, -17, -1, -17, 38, -11, 8, 22, -16, -22, 2, -32, 56, -82, 63, -56, 
  38, -28, -13, -44, 50, -34, 49, 56, 48, 35, -61, 27, -28, 40, -14, 35, 85, 67, 
  -48, 19, -8, 40, 23, 41, -14, 55, 11, -3, 12, 46, 33, 58, 52, 2, 19, 37, 
  17, 20, 4, -24, -38, -23, 20, 11, -38, 48, -51, 31, -91, 12, -98, 53, -49, 41, 
  2, 50, 17, 1, -17, -21, 5, 66, -17, 17, -55, -8, -71, 33, -36, 39, -101, 39, 
  4, 6, -21, -39, -49, -39, -15, 84, -18, -1, -19, 40, -32, 83, -31, 39, -88, -3, 
  37, -72, 18, 42, 51, 7, -17, 14, -40, 41, -67, 59, -12, 22, -18, -55, 34, 0, 
  16, 5, 34, -30, 22, -22, 57, -41, 13, -30, 54, -40, 38, -42, 12, -46, -11, -88, 
  -21, 37, -40, -27, -39, 62, -58, -38, -18, -88, 5, -98, 12, -67, 34, 102, 66, 106, 
  79, 29, 33, -53, -102, 8, -16, 28, -71, 9, -68, -8, 26, -54, 81, -41, 51, 39, 
  48, -18, 80, -7, 33, -51, 91, -34, 62, -37, 95, -24, 65, -23, 19, -31, 4, -70, 
  -18, -50, -9, -12, 1, -40, -39, -47, -50, 32, -59, -21, -65, 40, -109, 46, -93, 5, 
  -4, -17, -51, 41, 50, 105, -75, 103, 5, 16, -48, 35, 27, 28, -47, -46, -96, 18, 
  21, -36, -28, 31, -15, -3, -18, 50, -9, 54, 11, -5, -104, 100, -121, 29, -127, 25, 
  4, 11, -3, -39, -6, 29, -1, 44, -2, 56, -4, 57, -29, 59, 2, 65, -2, 57, 
  24, -41, -14, -12, 84, -43, -7, -53, 49, -95, 4, -87, 18, -56, 1, -46, -47, -67, 
  18, 8, 46, 32, 35, 0, 14, 32, 18, 25, 10, 52, 3, 57, -25, 41, -36, 47, 
  -9, -21, 53, -62, 77, -7, 35, -22, 35, -40, 21, -55, -32, -59, -3, -60, 27, -99, 
  12, 28, 4, -33, 44, -45, 83, -28, 71, 0, 8, -14, 66, -40, 15, -47, -56, -105, 
};
const TfArray<2, int> tensor_dimension6 = { 2, { 20,18 } };
const TfArray<1, float> quant6_scale = { 1, { 0.0063517307862639427, } };
const TfLiteAffineQuantization quant6 = { (TfLiteFloatArray*)&quant6_scale, (TfLiteIntArray*)&g0::quant1_zero, 0 };
const TfArray<2, int> tensor_dimension7 = { 2, { 1,20 } };
const TfArray<1, float> quant7_scale = { 1, { 0.03493310883641243, } };
const TfArray<1, int> quant7_zero = { 1, { -128 } };
const TfLiteAffineQuantization quant7 = { (TfLiteFloatArray*)&quant7_scale, (TfLiteIntArray*)&quant7_zero, 0 };
const TfArray<2, int> tensor_dimension8 = { 2, { 1,10 } };
const TfArray<1, float> quant8_scale = { 1, { 0.083770290017127991, } };
...
const TfArray<1, float> quant9_scale = { 1, { 0.30235931277275085, } };
...
TfLiteStatus tflite_learn_1047038_8_init( void*(*alloc_fnc)(size_t,size_t) ) {
...
TfLiteStatus tflite_learn_1047038_8_input(int index, TfLiteTensor *tensor) {
  init_tflite_tensor(in_tensor_indices[index], tensor);
  return kTfLiteOk;
}

TfLiteStatus tflite_learn_1047038_8_output(int index, TfLiteTensor *tensor) {
  init_tflite_tensor(out_tensor_indices[index], tensor);
  return kTfLiteOk;
}

TfLiteStatus tflite_learn_1047038_8_invoke() {
...
TfLiteStatus tflite_learn_1047038_8_reset( void (*free_fnc)(void* ptr) ) {
#ifdef EI_CLASSIFIER_ALLOCATION_HEAP
